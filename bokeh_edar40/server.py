...
def bk_worker():
	...
	server = Server({'/perfil': modify_first_descriptive, '/prediccion': modify_second_descriptive}, io_loop=IOLoop(), allow_websocket_origin=[f'{SERVER_IP}:9995', f'{SERVER_IP}:9090'], port=9090)
	server.start()
